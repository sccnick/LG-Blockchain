...
return{
	get_all_lg: function(req, res){
		console.log("getting all lg from database: ");
	...
	add_lg: function(req, res){
		console.log("submit recording of a tuna catch: ");
		console.log(req.params)
		var array = req.params.lg.split("-");
		console.log(array);

		var key = array[0]
		var dealer_names = array[2]
		var beneficiary_names = array[3]
		var guarantee_amount = array[1]
		var document_name = array[4]
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    const request = {
		        ...
		        chaincodeId: 'lg-app',
		        fcn: 'recordLG',
		        args: [key, dealer_names, beneficiary_names, guarantee_amount, document_name],
		        chainId: 'mychannel',
		        txId: tx_id
		    };
	...
	add_lgpost: function(req, res){
		...
		var dealer_names = req.body.dealer_names
		var beneficiary_names = req.body.beneficiary_names
		var guarantee_amount = req.body.guarantee_amount
